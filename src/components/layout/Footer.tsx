...
export default function Footer() {
  ...
  const footerSections = [
    ...
    },
    {
      title: 'Company',
      links: [
        { name: 'About Example Tech', href: '#about' },
  ...
  const handleSocialClick = (platform: string) => {
    console.log(`Navigating to ${platform} social media`);
  };
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Powering the next generation of cloud infrastructure with cutting-edge technology
                solutions. Trusted by enterprise clients worldwide for scalable, secure, and
                reliable systems.
              </p>
            </div>
            ...
            {/* Newsletter Signup */}
            <div className="space-y-3">
              <h4 className="font-semibold text-sm">Tech Updates</h4>
              ...
              <p className="text-xs text-muted-foreground">
                Get technical insights and product updates. Enterprise-focused content only.
              </p>
            </div>
          </div>
